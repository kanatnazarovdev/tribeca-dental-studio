...
export const IMPLANT_SERVICES: ServiceItem[] = [
  ...
  },
  {
    ...
    image: "/services/all-on-4-dental-implants.webp"
  },
  {
    num: "13",
...
export const GENERAL_SERVICES: ServiceItem[] = [
  {
    ...
    image: "/services/teeth-cleaning.webp"
  },
  {
    num: "16",
    ...
    image: "/services/preventive-dentistry.webp"
  },
  {
    num: "17",
...
export const SPECIALIZED_SERVICES: ServiceItem[] = [
  ...
  },
  {
    ...
    image: "/services/tooth-extractions.webp"
  },
  {
    num: "27",
...
export const FEATURED_SERVICES: ServiceItem[] = [
  ...COSMETIC_SERVICES.slice(0, 2),       // Cosmetic Dentistry, Veneers
  ...IMPLANT_SERVICES.slice(0, 2),        // Dental Implants, All-on-4
  ...GENERAL_SERVICES.slice(0, 2),        // Dental Exams, Preventive
  ...SPECIALIZED_SERVICES.slice(0, 2),    // Oral Surgery, Extractions
  ...AIRWAY_AND_ORTHO_SERVICES.slice(0, 2) // Airway Treatments, Sleep Apnea
];