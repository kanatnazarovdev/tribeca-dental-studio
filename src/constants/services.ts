...
export const SPECIALIZED_SERVICES: ServiceItem[] = [
  ...
  {
    num: "23",
    titleEn: "Transnasal Dental Implants",
    titleEs: "Implantes Dentales Transnasales",
    slug: "services/transnasal-dental-implants",
    image: "/services/transnasal-dental-implants.webp"
  },
  {
    num: "24",
