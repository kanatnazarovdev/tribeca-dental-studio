...
export const COSMETIC_SERVICES: ServiceItem[] = [
  ...
  },
  {
    ...
    slug: "services/brius-invisible-braces",
  ...
  },
  {
    ...
    slug: "services/cosmetic-laser-treatments-skin-dental",
...
export const SPECIALIZED_SERVICES: ServiceItem[] = [
  ...
  },
  {
    ...
    slug: "services/crown-lengthening-gummy-smile",
