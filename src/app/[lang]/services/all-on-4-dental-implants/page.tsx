...
export default function AllOn4Page({ params }: PageProps) {
  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      // 1. HERO ANIMATION: Entrance Timeline
              ...
              >
                <Image
                  ...
                  className={`object-cover transition-all duration-1000 ${
                    activeTab === "after" ? "contrast-110 scale-100" : "grayscale contrast-125 scale-105"
                  }`}
                ...
                <div className="absolute top-6 right-6 z-30 flex items-center bg-black/70 backdrop-blur-md border border-white/20 p-1 rounded-full">
                  <button
                    ...
                    className={`px-4 py-1.5 rounded-full text-[10px] font-mono uppercase tracking-widest transition-all ${
                      activeTab === "after" ? "bg-[#C5A059] text-black font-bold" : "text-white/70 hover:text-white"
                    }`}
                  >
                  ...
                  <button
                    ...
                    className={`px-4 py-1.5 rounded-full text-[10px] font-mono uppercase tracking-widest transition-all ${
                      activeTab === "before" ? "bg-[#C5A059] text-black font-bold" : "text-white/70 hover:text-white"
                    }`}
                  >
